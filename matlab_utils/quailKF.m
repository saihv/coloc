...
QuailAccel_noise_mag = 0.00006 ; %process noise: the variability in how fast the Quail is speeding up (stdv of acceleration: meters/sec^2)
NinjaVision_noise_mag = 10000;  %measurement noise: How mask-blinded is the Ninja (stdv of location, in meters)
