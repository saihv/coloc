...
namespace matplotlibcpp {
	...
	namespace detail {
		...
		private:
			...
			_interpreter() {
				...
				s_python_function_plot = PyObject_GetAttrString(pymod, "scatter");
	...
	template<typename Numeric>
	bool scatter(const std::vector<Numeric> &x, const std::vector<Numeric> &y, const std::map<std::string, std::string>& keywords)
	{
		assert(x.size() == y.size());
	...
	*/
	...
	bool scatter(const std::vector<double>& x, const std::vector<double>& y, const std::string& format = "") {
