...
int main(int argc, char **argv)
{
  ...
  std::string sSfM_Data_Filename = "C:\\Users\\saihv\\Desktop\\test\\sfm_data.bin";
  std::string sMatchesDir = "C:\\Users\\saihv\\Desktop\\test\\";
  std::string sOutDir = "C:\\Users\\saihv\\Desktop\\test\\";
  std::string sMatchesOutDir;
  std::string sQueryDir = "C:\\Users\\saihv\\Desktop\\test\\q\\";
